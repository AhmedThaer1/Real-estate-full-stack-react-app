...
// to fetch and find how many properties are there from each type
propertyController.get('/find/types', async (req, res) => {
    try {
        // edit here to add mre types whichs the erea like almansor , alsharqia , alshamalia what ever...
        ...
        const baghdadType = await Property.countDocuments({ type: 'baghdad' })

        return res.status(200).json({ beach: beachType,
