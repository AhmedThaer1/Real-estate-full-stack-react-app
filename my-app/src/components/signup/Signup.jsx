...
const Signup = () => {
  ...
  return (
    <div className={classes.container}>
      <button className={classes.backButton}><Link style={{color: 'inherit'}} to={'/'}>Back Home</Link></button>
      <div className={classes.wrapper}>
        ...
        <form onSubmit={handleRegister}>
          ...
          <input
              type="checkbox"
              checked={uploadPhoto}
              onChange={() => setUploadPhoto(!uploadPhoto)}
            />
            <span className={classes.span}>هل تريد اضافه صوره </span><AiOutlineFileImage className={classes.spanIcon}/>
          </label>
          {uploadPhoto && (
          <input 
          style={{ display: 'none' }}
