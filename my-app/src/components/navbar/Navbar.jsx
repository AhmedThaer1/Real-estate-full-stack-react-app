...
import compLogo from '../../assets/Logo/aqari-rounded2.png'
    ...
    <div className={`${classes.container} ${isScrolled && classes.scrolled}`}>
      <div className={classes.wrapper}>
        <Link to='/' onClick={scrollToTop} className={classes.left}>
          <img src={compLogo} className={classes.logo} alt="#" />
        </Link>
        <ul className={classes.center}>
          ...
          <li className={classes.listItem}>
            <Link  to={`/yachts`} style={{textDecoration: 'none', color: 'inherit'}}>Featured</Link>
          </li>
        </ul>
          ...
          {!user ?
            ...
            <>
              <span className={classes.username} onClick={() => setShowModal(prev => !prev)}>
                <FaUserCog className={classes.profIcon}/>
                 <span>Profile</span> 
                </span>
                {user._id === '64d40fb0a7e58ec24afa5804' ? <>
                {showModal && (
                <div className={`${classes.userModal} ${classes.scaleUpVerCenter}`}>
                  ...
                  <Link onClick={() => setShowModal(prev => !prev)} className={classes.list} to={`/yachts`}>Check Featuered!</Link>
                  <Link to={`/create-yacht`} onClick={() => setShowModal(prev => !prev)} className={classes.list}>List your Featured</Link>
        ...
        <div className={classes.mobileNav}>
          {showMobileNav &&
            <div className={classes.navigation}>
              <Link to='/' onClick={scrollToTop} className={classes.left}>
              <img src={compLogo} className={classes.logoMD} alt="#" />
              </Link>
              ...
              <ul className={classes.center}>
                ...
                <li className={classes.listItem}>
                  <Link to={`/yachts`}>Featured</Link>
                </li>
                <div className={classes.right}>
                {!user ?
                  <>
                    <Link className={classes.sign} to='/signup'>Sign up</Link>
                    <Link className={classes.sign} to='/signin'>Sign in</Link>
                  </>
                  :
                  <>
                    {user._id === '64d40fb0a7e58ec24afa5804' ? 
