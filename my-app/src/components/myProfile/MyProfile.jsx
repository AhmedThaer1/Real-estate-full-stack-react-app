        ...
        <div className={classes.container}>
            <div className={classes.wrapper}>
                ...
                <div className={classes.catalog}>
                            ...
                            <div className={classes.properties}>
                                {listedProperties?.length > 0 ? listedProperties?.map((listedProperty) => (
                                    <div key={listedProperty._id} className={classes.property}>
                                        ...
                                        <h3 className={classes.nameTitle}>{listedProperty.title}</h3>
                    ...
                    {activeBtn === 1 && (
                        <>
                            {listedYachts?.length > 0 && <h2 className={classes.title}>Listed Featured</h2>}
                            ...
                            ) : <h2 className={classes.noListed}>You have no listed featured</h2>}
                        </>
                    )}
                    {activeBtn === 2 && (
                        <>
                    ...
                    {activeBtn === 3 && (
                        <>
                            {bookmarkedYachts?.length > 0 && <h2 className={classes.title}>Bookmarked Featured</h2>}
                            ...
                            ) : <h2 className={classes.noListed}>You have no bookmarked featured</h2>}
                        </>
                    )}
                </div>
                {error && (
