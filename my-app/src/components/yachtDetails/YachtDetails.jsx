...
const YachtDetails = () => {
    ...
    return (
        <div className={classes.container}>
            <h3 style={{ textAlign: 'center', marginBottom: '2.5rem', fontSize: '32px', marginTop: '-2.5rem' }}>المميزات المعروضه</h3>
            <div className={classes.wrapper}>
                ...
                <div className={classes.right}>
                    ...
                    <div className={classes.location}>الموقع: <span>{yacht?.location}</span></div>
                    <div className={classes.price}>السعر: <span>$ {yacht?.price}</span></div>
                    <div className={classes.passengers}>عددالغرف: <span>{yacht?.maxPassengers}</span></div>
                    <div className={classes.descContainer}>الوصف: <p>{yacht?.desc}</p></div>
                    <div className={classes.metersLong}>المساحه: <span>{yacht?.metersLong}</span></div>
